...
uint16_t i40e_xmit_pkts_vec_avx512(void *tx_queue,
				   struct rte_mbuf **tx_pkts,
				   uint16_t nb_pkts);
uint16_t i40e_recv_pkts_vec_lasx(void *rx_queue, struct rte_mbuf **rx_pkts,
	uint16_t nb_pkts);
uint16_t i40e_recv_scattered_pkts_vec_lasx(void *rx_queue,
	struct rte_mbuf **rx_pkts, uint16_t nb_pkts);
uint16_t i40e_xmit_pkts_vec_lasx(void *tx_queue, struct rte_mbuf **tx_pkts,
	uint16_t nb_pkts);
