...
#ifndef __INCLUDE_IP4_LOOKUP_LSX_H__
#define __INCLUDE_IP4_LOOKUP_LSX_H__
			...
			void **objs, uint16_t nb_objs)
{
	...
	while (n_left_from >= 4) {
		...
		dip = lsx_set_w(ip3, ip2, ip1, ip0);

		/* Byte swap 4 IPV4 addresses. */
		dip = __lsx_vshuf4i_b(dip, 0x1B /* 00 01 10 11 */);
...
#endif /* __INCLUDE_IP4_LOOKUP_LSX_H__ */
