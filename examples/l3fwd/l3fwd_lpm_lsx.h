...
{
	rte_xmm_t dst;
	const  __m128i bswap_mask = lsx_set_b(12, 13, 14, 15, 8, 9, 10, 11,
						4, 5, 6, 7, 0, 1, 2, 3);

	/* Byte swap 4 IPV4 addresses. */
	dip = lsx_vshuffle_b(dip, bswap_mask);
	...
	if (likely(ipv4_flag)) {
		...
		dst.x = __lsx_vssrarni_h_w(dst.x, dst.x, 0);
