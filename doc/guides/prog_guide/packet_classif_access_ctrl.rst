...
*   **RTE_ACL_CLASSIFY_LSX**: vector implementation, can process up to 8 flows in parallel. Requires LSX support.
    Requires max SIMD bitwidth to be at least 128.

*   **RTE_ACL_CLASSIFY_LASX**: vector implementation, can process up to 16 flows in parallel. Requires LASX support.
    Requires max SIMD bitwidth to be at least 256.
